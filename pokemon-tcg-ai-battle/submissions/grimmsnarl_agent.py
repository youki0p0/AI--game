...
# --- トップ層の勝者(tonakaiiii)の60枚をそのまま採用 ---------------------------
GRIMM_DECK = (
    [648] * 3 + [647] * 3 + [646] * 4 + [104] * 2 + [860] * 2 + [112] * 4  # Pokémon(18)
    + [1086] * 4 + [1152] * 4 + [1079] * 3 + [1097] * 3 + [1080] * 1        # Poffin/PokePad/RareCandy/NightStretcher/UnfairStamp
    + [1227] * 4 + [1219] * 4 + [1182] * 2 + [1231] * 1                     # Lillie/Petrel/Boss/Dawn
    + [1161] * 2 + [1259] * 4                                               # HandheldFan/Spikemuth Gym
