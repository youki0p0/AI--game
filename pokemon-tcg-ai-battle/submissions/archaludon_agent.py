...
ARCH_DECK = ([169]*4+[190]*4+[666]*4+[1244]*4+[8]*13+[1152]*4+[1121]*4+[1122]*4+[1097]*4+[1197]*3+[1147]*2+[1159]*1+[1182]*1+[1185]*4+[1227]*4)
assert len(ARCH_DECK) == 60

ENERGY_ID = 8          # 基本悪エネルギー
SHADOW_BULLET = -1  # (Archaludon: 最大ダメ選択に委ねる)    # Grimmsnarl の本命技(180+ベンチ30, 2エネ)
GRIMMSNARL, MORGREM, IMPIDIMP = 190, 169, 666
RARE_CANDY = 1079
MUNKIDORI = 666
# 進化の優先: Grimmsnarl(攻撃) > Morgrem > Froslass
EVOLVE_PRIORITY = {190: 300, 169: 150}
ATTACKER_PRIORITY = [190, 666, 169]
...
# デッキ→手札サーチで優先するカード
SEARCH_PRIORITY = [190, 169, 666, 1227, 1182, 1121, 1152, 1097, 8]
