...
STARMIE_DECK = ([3]*9+[17]*4+[666]*4+[1030]*3+[1031]*3+[1086]*4+[1097]*2+[1120]*4+[1121]*1+[1122]*4+[1145]*4+[1159]*1+[1182]*1+[1189]*4+[1223]*2+[1225]*2+[1227]*4+[1229]*4)
assert len(STARMIE_DECK) == 60

ENERGY_ID = 3          # 基本悪エネルギー
SHADOW_BULLET = 1487  # Jetting Blow(120,1水) を本命扱い    # Grimmsnarl の本命技(180+ベンチ30, 2エネ)
GRIMMSNARL, MORGREM, IMPIDIMP = 1031, 1030, 666  # (primary=Mega Starmie ex/Staryu/Cinderace)
RARE_CANDY = 1079
MUNKIDORI = 666  # Cinderace(accel)
# 進化の優先: Grimmsnarl(攻撃) > Morgrem > Froslass
EVOLVE_PRIORITY = {1031: 300, 666: 250, 1030: 150}
ATTACKER_PRIORITY = [1031, 666, 1030]
...
# デッキ→手札サーチで優先するカード
SEARCH_PRIORITY = [1145, 1031, 666, 1030, 1189, 1227, 1182, 1086, 1152, 3]
